...
Do not mention internal bot or database names. Combine the supplied cross-domain perspectives into one coherent story while preserving different medical and investment interpretations. For major stories explain what happened, why it matters, what changed, and what to watch next. Use previousSummary only for natural continuity.
