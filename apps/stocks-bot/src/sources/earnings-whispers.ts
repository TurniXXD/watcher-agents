    ...
    return [
      {
        ...
        normalizedFacts: {
          ...
          nextEarningsConfirmedAt: upcoming?.confirmDate,
          nextEarningsQuarter: upcoming?.quarter,
          nextEarningsQuarterEnd: upcoming?.quarterDate,
          consensusEstimate: upcoming?.consensusEst,
          earningsWhisper: upcoming?.whisper,
          nextRevenueEstimate: upcoming?.revenueEst,
          latestEarningsDate: latest?.epsDate,
          latestEarningsQuarter: latest?.quarter,
          latestEps: latest?.eps,
          latestEstimate: latest?.estimate,
          latestEarningsWhisper: latest?.whisper,
          latestEpsHighEstimate: latest?.highEstimate,
          latestEpsLowEstimate: latest?.lowEstimate,
          epsSurprise: latest?.earningsSurprise,
          latestRevenue: latest?.revenue,
          latestRevenueEstimate: latest?.revenueEstimate,
          revenueSurprise: latest?.revenueSurprise,
        },
