...
const schema = z
  .object({
    ...
    OLLAMA_MAX_ITEMS_PER_RUN: z.coerce
      .number()
      .int()
      .min(0)
      .max(1000)
    ...
    MARKET_BASELINE_MIN_SNAPSHOTS: z.coerce
      ...
      .max(20)
      .default(5),
    OPTIONS_VOLUME_OI_ANOMALY_THRESHOLD: z.coerce
      .number()
      .positive()
      .default(2),
    ...
    DISCOVERY_MIN_DOLLAR_VOLUME: z.coerce
      ...
      .nonnegative()
      .default(1_000_000),
    DISCOVERY_MAX_CANDIDATES: z.coerce
      .number()
      .int()
      .min(1)
      .max(100)
  ...
  .superRefine((value, context) => {
    if (
      Boolean(value.ALPACA_PAPER_API_KEY) !==
      Boolean(value.ALPACA_PAPER_API_SECRET)
    ) {
      context.addIssue({
